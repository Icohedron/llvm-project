...
// CHECK-LABEL: define hidden noundef <6 x i32> @_Z5call6v(
// CHECK-SAME: ) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[M:%.*]] = alloca [9 x i32], align 4
// ROW-CHECK-NEXT:    [[T:%.*]] = alloca [2 x <3 x i32>], align 4
// COL-CHECK-NEXT:    [[T:%.*]] = alloca [3 x <2 x i32>], align 4
// CHECK-NEXT:    [[AGG_TEMP:%.*]] = alloca [9 x i32], align 4
// CHECK-NEXT:    [[FLATCAST_TMP:%.*]] = alloca <6 x i32>, align 4
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[M]], ptr align 4 @__const._Z5call6v.M, i32 36, i1 false)
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[AGG_TEMP]], ptr align 4 [[M]], i32 36, i1 false)
// CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 0
// CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 1
// CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 2
// CHECK-NEXT:    [[GEP3:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 3
// CHECK-NEXT:    [[GEP4:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 4
// CHECK-NEXT:    [[GEP5:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 5
// CHECK-NEXT:    [[GEP6:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 6
// CHECK-NEXT:    [[GEP7:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 7
// CHECK-NEXT:    [[GEP8:%.*]] = getelementptr inbounds [9 x i32], ptr [[AGG_TEMP]], i32 0, i32 8
// CHECK-NEXT:    [[TMP0:%.*]] = load <6 x i32>, ptr [[FLATCAST_TMP]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[GEP]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = insertelement <6 x i32> [[TMP0]], i32 [[TMP1]], i64 0
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[GEP1]], align 4
// ROW-CHECK-NEXT:    [[TMP4:%.*]] = insertelement <6 x i32> [[TMP2]], i32 [[TMP3]], i64 1
// COL-CHECK-NEXT:    [[TMP4:%.*]] = insertelement <6 x i32> [[TMP2]], i32 [[TMP3]], i64 2
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[GEP2]], align 4
// ROW-CHECK-NEXT:    [[TMP6:%.*]] = insertelement <6 x i32> [[TMP4]], i32 [[TMP5]], i64 2
// COL-CHECK-NEXT:    [[TMP6:%.*]] = insertelement <6 x i32> [[TMP4]], i32 [[TMP5]], i64 4
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[GEP3]], align 4
// ROW-CHECK-NEXT:    [[TMP8:%.*]] = insertelement <6 x i32> [[TMP6]], i32 [[TMP7]], i64 3
// COL-CHECK-NEXT:    [[TMP8:%.*]] = insertelement <6 x i32> [[TMP6]], i32 [[TMP7]], i64 1
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[GEP4]], align 4
// ROW-CHECK-NEXT:    [[TMP10:%.*]] = insertelement <6 x i32> [[TMP8]], i32 [[TMP9]], i64 4
// COL-CHECK-NEXT:    [[TMP10:%.*]] = insertelement <6 x i32> [[TMP8]], i32 [[TMP9]], i64 3
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[GEP5]], align 4
// CHECK-NEXT:    [[TMP12:%.*]] = insertelement <6 x i32> [[TMP10]], i32 [[TMP11]], i64 5
// CHECK-NEXT:    store <6 x i32> [[TMP12]], ptr [[T]], align 4
// CHECK-NEXT:    [[TMP13:%.*]] = load <6 x i32>, ptr [[T]], align 4
// CHECK-NEXT:    ret <6 x i32> [[TMP13]]
//
int2x3 call6() {
...
// CHECK-LABEL: define hidden noundef <6 x i32> @_Z5call7v(
// CHECK-SAME: ) #[[ATTR0]] {
// CHECK-NEXT:  [[ENTRY:.*:]]
// CHECK-NEXT:    [[M:%.*]] = alloca [6 x i32], align 4
// ROW-CHECK-NEXT:    [[T:%.*]] = alloca [3 x <2 x i32>], align 4
// COL-CHECK-NEXT:    [[T:%.*]] = alloca [2 x <3 x i32>], align 4
// CHECK-NEXT:    [[AGG_TEMP:%.*]] = alloca [6 x i32], align 4
// CHECK-NEXT:    [[FLATCAST_TMP:%.*]] = alloca <6 x i32>, align 4
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[M]], ptr align 4 @__const._Z5call7v.M, i32 24, i1 false)
// CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 4 [[AGG_TEMP]], ptr align 4 [[M]], i32 24, i1 false)
// CHECK-NEXT:    [[GEP:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 0
// CHECK-NEXT:    [[GEP1:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 1
// CHECK-NEXT:    [[GEP2:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 2
// CHECK-NEXT:    [[GEP3:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 3
// CHECK-NEXT:    [[GEP4:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 4
// CHECK-NEXT:    [[GEP5:%.*]] = getelementptr inbounds [6 x i32], ptr [[AGG_TEMP]], i32 0, i32 5
// CHECK-NEXT:    [[TMP0:%.*]] = load <6 x i32>, ptr [[FLATCAST_TMP]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[GEP]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = insertelement <6 x i32> [[TMP0]], i32 [[TMP1]], i64 0
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[GEP1]], align 4
// ROW-CHECK-NEXT:    [[TMP4:%.*]] = insertelement <6 x i32> [[TMP2]], i32 [[TMP3]], i64 1
// COL-CHECK-NEXT:    [[TMP4:%.*]] = insertelement <6 x i32> [[TMP2]], i32 [[TMP3]], i64 3
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[GEP2]], align 4
// ROW-CHECK-NEXT:    [[TMP6:%.*]] = insertelement <6 x i32> [[TMP4]], i32 [[TMP5]], i64 2
// COL-CHECK-NEXT:    [[TMP6:%.*]] = insertelement <6 x i32> [[TMP4]], i32 [[TMP5]], i64 1
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[GEP3]], align 4
// ROW-CHECK-NEXT:    [[TMP8:%.*]] = insertelement <6 x i32> [[TMP6]], i32 [[TMP7]], i64 3
// COL-CHECK-NEXT:    [[TMP8:%.*]] = insertelement <6 x i32> [[TMP6]], i32 [[TMP7]], i64 4
// CHECK-NEXT:    [[TMP9:%.*]] = load i32, ptr [[GEP4]], align 4
// ROW-CHECK-NEXT:    [[TMP10:%.*]] = insertelement <6 x i32> [[TMP8]], i32 [[TMP9]], i64 4
// COL-CHECK-NEXT:    [[TMP10:%.*]] = insertelement <6 x i32> [[TMP8]], i32 [[TMP9]], i64 2
// CHECK-NEXT:    [[TMP11:%.*]] = load i32, ptr [[GEP5]], align 4
// CHECK-NEXT:    [[TMP12:%.*]] = insertelement <6 x i32> [[TMP10]], i32 [[TMP11]], i64 5
// CHECK-NEXT:    store <6 x i32> [[TMP12]], ptr [[T]], align 4
// CHECK-NEXT:    [[TMP13:%.*]] = load <6 x i32>, ptr [[T]], align 4
