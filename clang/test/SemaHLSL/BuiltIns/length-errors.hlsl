...
void test_too_few_arg()
{
  ...
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but no arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but no arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but no arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but no arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but no arguments were provided}}
...
void test_too_many_arg(float2 p0)
{
  return length(p0, p0);
  // expected-error@-1 {{no matching function for call to 'length'}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but 2 arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but 2 arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but 2 arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but 2 arguments were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires single argument 'X', but 2 arguments were provided}}
