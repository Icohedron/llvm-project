...
float test_no_second_arg(float3 p0) {
  ...
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 1 was provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 1 was provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 1 was provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 1 was provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 1 was provided}}
...
float test_no_third_arg(float3 p0) {
  ...
  // expected-error@-1 {{no matching function for call to 'refract'}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 2 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 2 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 2 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 2 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 2 were provided}}
...
float test_too_many_arg(float2 p0) {
  ...
  // expected-error@-1 {{no matching function for call to 'refract'}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 4 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 4 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 4 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 4 were provided}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function not viable: requires 3 arguments, but 4 were provided}}
...
float test_double_inputs(double p0, double p1, double p2) {
  ...
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function}}
  // expected-note@hlsl/hlsl_detail_intrinsics_gen.inc:* {{candidate function}}
}
